...
// CORSのエラーがあるので一度リトライする
return e?(alert("image load error"),!0):(e=!0,d.open("GET","//allow-any-origin.appspot.com/"+b.substr(1),!0),void d.send())},d.onload=function(b){var c=b.target.response;if(Worker){
// enable web workers
var d=new Worker("/js/task.min.js?1");d.onmessage=function(b){a.src=b.data.src},d.postMessage({buffer:c,action:"reverse"})}else{
// disable web workers
var e=window.gifken.Gif.parse(c);a.src=URL.createObjectURL(window.gifken.GifPresenter.writeToBlob(e.playback(!0).writeToArrayBuffer()))}},d.send()}addEventListener("load",a,!1)}();