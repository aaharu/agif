  ...
  return (
    <>
      ...
      <a
        ...
        style={{ display: values.url && !values.urlInvalid ? "" : "none" }}
        target="_blank"
        href={"/page/split#" + values.url}
      >
        <Card square={true}>
          <CardContent>
